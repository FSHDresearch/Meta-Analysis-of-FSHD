---
title: "Summary of GSE10760 for Meta-Analysis"
...
```{r}
exportData <- readRDS(file = "../rds/GSE10760data.rds")
...
```{r}
res.GSE10760 <- res
res.GSE10760$ENSEMBL <- IDs
save(res.GSE10760, file = "summary_GSE10760.RData")
```
