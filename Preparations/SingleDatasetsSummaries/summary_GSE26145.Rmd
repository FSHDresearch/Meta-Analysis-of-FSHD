---
title: "Summary of GSE26145 for Meta-Analysis"
...
```{r}
exportData <- readRDS(file = "../rds/GSE26145data.rds")
...
```{r}
res.GSE26145 <- res
res.GSE26145$ENSEMBL <- IDs
save(res.GSE26145, file = "summary_GSE26145.RData")
```
