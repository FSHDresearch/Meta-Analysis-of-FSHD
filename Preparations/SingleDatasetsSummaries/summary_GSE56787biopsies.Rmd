---
title: "Summary of GSE56787 (biopsies) for Meta-Analysis"
...
```{r}
exportData <- readRDS(file = "../rds/GSE56787data_biopsy.rds")
...
```{r}
res.GSE56787 <- res
res.GSE56787$ENSEMBL <- IDs
save(res.GSE56787, file = "summary_GSE56787biopsies.RData")
```
