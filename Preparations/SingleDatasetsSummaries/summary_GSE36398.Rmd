---
title: "Summary of GSE36398 for Meta-Analysis"
...
```{r}
exportData <- readRDS(file = "../rds/GSE36398data.rds")
normData <- t(exportData[,10:ncol(exportData)])
```
...
GeneID <- select(hugene10sttranscriptcluster.db, 
                 keys = keys(hugene10sttranscriptcluster.db), 
...
```{r}
res.GSE36398 <- res
res.GSE36398$ENSEMBL <- IDs
save(res.GSE36398, file = "summary_GSE36398.RData")
```
