---
title: "Summary of GSE15090 for Meta-Analysis"
...
```{r}
exportData <- readRDS(file = "../rds/GSE15090data.rds")
normData <- t(exportData[,8:ncol(exportData)])
```
...
```{r}
res.GSE15090 <- res
res.GSE15090$ENSEMBL <- IDs
save(res.GSE15090, file = "summary_GSE15090.RData")
```
